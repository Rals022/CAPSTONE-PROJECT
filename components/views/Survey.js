...
export default () => html`
  <form id="surveyForm" method="POST" action="">
    ...
    <fieldset>
      ...
      <div id="question1">
        <input type="number" id="greetingCustomer" min="1" max="10" required />
      </div>

      <legend>Knowledge and professionalism of staff</legend>
      <div id="question2">
        <input type="number" id="knowledge" min="1" max="10" required />
      </div>

      <legend>Explanation of estimate and repairs</legend>
      <div id="question3">
        <input type="number" id="explanation" min="1" max="10" required />
      </div>
      ...
      <div id="question6">
        <input type="number" id="likelihood" min="1" max="10" required />
      </div>
    </fieldset>
    ...
    <label for="comment1">What made you select us for your repair work?</label>
